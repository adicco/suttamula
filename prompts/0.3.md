...
- Leave certain Pāli terms untranslated, as defined below. Italicize them in Markdown using *term* (not *term*).
- Conjugate derived terms to fit the context (e.g. "fully aware" as an adverbial participle for "full awareness").
...
- nikāya
- bhava
- nāma (leave untranslated in the context of nāma as 'mentality'. In other contexts, such as when it refers to someone's name, translate straightforwardly.)
- rūpa
- nāmarūpa
- nimitta
- kāmabhavo
...
- anattā -> not-self [*anattā*] (do NOT translate as "no self") 
- bhagavā -> the *Bhagavā*
...
- anusaya -> underlying tendency [*anusaya*]
